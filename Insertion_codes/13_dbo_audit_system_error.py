...
def main():
    ...
    try:
        azure_dbo_path = get_azure_blob_path("dbo")
        ...
        write_parquet(cfg_df.select("ConfigID","ConfigKey","ConfigValue","Description","DataType","IsEncrypted","ModifiedBy","ModifiedDate"),
                      f"{azure_dbo_path}/configuration")
        ...
        write_parquet(audit_schema, f"{azure_dbo_path}/audit_log")
        ...
        write_parquet(error_schema, f"{azure_dbo_path}/error_log")
